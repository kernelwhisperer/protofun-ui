...
export const METRIC_DESC_MAP: Partial<
  Record<ProtocolId, Partial<Record<MetricId, Descriptions>>>
> = {
  eth: {
    base_fee: {
      description: (
        <React.Fragment>
          Base fee per gas is the{" "}
          <i>minimum amount that you must pay for your transaction</i> to be
