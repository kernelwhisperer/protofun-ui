  ...
  return (
    ...
    >
      ...
      <Stack direction="row">
        ...
        <LegendValue>
          {formatNumber(new Decimal(block?.baseFeePerGas).div(1e9).toNumber())}{" "}
          Gwei
        </LegendValue>
      </Stack>
      <Stack direction="row">
      ...
      <Stack direction="row">
        ...
        <LegendValue>
          {formatNumber(new Decimal(block?.minerTips).div(1e18).toNumber(), 3)}{" "}
          ETH
        </LegendValue>
      </Stack>
      <Stack direction="row">
        ...
        <LegendValue>
          {formatNumber(new Decimal(block?.burnedFees).div(1e18).toNumber(), 3)}{" "}
          ETH
        </LegendValue>
      </Stack>
